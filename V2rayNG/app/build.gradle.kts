...
android {
    // Keep the source namespace unchanged to preserve upstream compatibility.
    // The installed Android package/application ID is MobileTina's own ID below.
    ...
    defaultConfig {
        ...
        targetSdk = 37
        versionCode = 743
        versionName = "2.3.3-mobiletina.1"
